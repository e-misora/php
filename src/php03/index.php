...
<body>
    ...
    <main>
        <div class="quiz__content">
            <div class="question">
                <p class="question__txt">Q.以下の内容に当てはまるステータスコードを選んでください</p>
            ...
            <div class="quiz-form__item">
                <?php foreach ($options as $option):?>
                    <div class="quiz-form__group">
                        <input class="quiz-form__radio" type="radio" id="<?php echo $option["code"]?>" name="option" value="<?php echo $option["code"]?>">
